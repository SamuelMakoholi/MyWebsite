        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Premium Prices</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Premium Prices and Description</h3>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('add.section.premium') }}" enctype="multipart/form-data">
                    @csrf
