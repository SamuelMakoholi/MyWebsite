        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Exclusive Prices</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Exclusive prices and description</h3>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('add.section.exclusive') }}" enctype="multipart/form-data">
                    @csrf
